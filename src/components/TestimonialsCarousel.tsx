          ...
          <div>
            ...
            <div className="mt-8 relative">
              ...
              <p className="relative text-slate-700 leading-8 pl-5">
                We were skeptical about AI, but Hyphen Labs&apos;s CRM integration completely changed our perspective. The AI sales assistant qualifies leads 3x faster, writes personalized outreach emails, and our pipeline conversion went from 12% to 31%. Our sales team actually loves it.
              </p>
            ...
            <button className="mt-10 inline-flex items-center gap-3 bg-slate-900 hover:bg-slate-800 transition px-7 py-4  text-white font-semibold"  style={{ marginTop: '18px' }}>
